...
function App() {
  ...
  return (
    <div className="flex flex-col items-center">
      <h4 className="text-xl self-start font-bold p-5 text-slate-600 bg-slate-300 w-full">Todo App</h4>
        ...
        <ul>
          {
            tasks.map((task,index)=>(
              <div className="flex bg-slate-100 m-2 py-4 pl-12 pr-4 rounded-md w-80" key={index}>
                ...
                className="bg-slate-50 p-2 mx-1 rounded-md font-bold hover:bg-slate-200"><i className="fa-solid fa-trash text-red-600"></i></button>
              </div>
            ))
          }
        </ul>
